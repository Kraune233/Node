...
const fs = require('fs');
const url = "https://en.wikipedia.org/wiki/Grand_Central_Terminal"; // FIRST: find a url of a page you are interested in from wikipedia 
const jsonPath = "./json/"; 
const name = "";
